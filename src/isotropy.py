...
class MultiConceptIsotropyEvaluator:
    ...
    def evaluate(self, model):
        ...
        results["general_isoscore"] = self.general_eval.iso_score_star(model, n_evals=200, general=True)
        ...
        for concept in self.concepts_to_eval:
            ...
            results[f"{concept}_isoscore"] = self.concept_evals[concept].iso_score_star(model, n_evals=200)
